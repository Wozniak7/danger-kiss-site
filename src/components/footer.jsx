                ...
                <div className="footer-top">
                    <div>
                        ...
                        <div className="social-links">
                            {/* Instagram */}
                            <a href="#" className="social-link" aria-label="Instagram" title="Instagram" onClick={e => e.preventDefault()}>
                            ...
                            {/* YouTube */}
                            <a href="#" className="social-link" aria-label="YouTube" title="YouTube" onClick={e => e.preventDefault()}>
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            {/* Facebook */}
                            <a href="#" className="social-link" aria-label="Facebook" title="Facebook" onClick={e => e.preventDefault()}>
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
